...
<div class="row">
    <div id="HomePageTopLeft" class="col-sm-7">
        ...
        <div id="LearnMore">
            <a class="btn btn-outline-success buttons" href="#Contact">Ask a Question</a>
        </div>

    </div>
    <div class="col-sm-5">
        <?php echo $this->Html->image('CroppedCompanyLogo.jpg', [
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div id="FeaturedImagesCarousel" class="carousel slide row" data-bs-ride="carousel" data-bs-interval="2000">
...
<div class="row">
    <div id="HomePageTopLeft" class="container">
        <div class="row">
        ...
        <div class="col-sm-3 NoPaddingMargins">
        ...
        <div class="col-sm-6 NoPaddingMargins">
            <?php echo $this->Html->image('homeaboutpic.jpg', [
                'alt' => 'About us image',
                'class' => 'img-fluid'
            ]);?>
        </div>
...
<div class="container">
    <div class="row NoPaddingMargins ">
