        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('housingTypeId') ?></th>
                    <th><?= $this->Paginator->sort('hasChildren') ?></th>
                    <th><?= $this->Paginator->sort('everOwnedDogs') ?></th>
                    <th><?= $this->Paginator->sort('primaryCareTaker') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= h($user->hasChildren) ?></td>
                    <td><?= h($user->everOwnedDogs) ?></td>
                    <td><?= h($user->primaryCareTaker) ?></td>
